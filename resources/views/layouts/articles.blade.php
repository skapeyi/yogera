          ...
          <div class="col-md-3">
            ...
            <div class="bs-example" data-example-id="simple-nav-stacked">
              <ul class="nav nav-pills nav-stacked nav-pills-stacked-example">
                <li role="presentation"><a href="/celebrate-a-person">Celebrate a Hero</a></li>
                <li role="presentation"><a href="/shame-a-person">Report a corrupt offical</a></li>
                <li role="presentation"><a href="/contact">Contact Us</a></li>
              </ul>
            </div>

            <div class="page-header">
              <a class="twitter-timeline" data-height="600" data-theme="light" href="https://twitter.com/YogeraUg">Tweets by YogeraUg</a> <script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>
            </div>
          </div>
        </div>
      </div>
